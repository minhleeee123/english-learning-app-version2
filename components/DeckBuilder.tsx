    ...
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-xl shadow-sm border border-slate-200">
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            type="text"
            className="w-full px-4 py-2 bg-white text-slate-900 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none placeholder-slate-400"
        ...
        <div>
          ...
          <textarea
            className="w-full px-4 py-2 h-40 bg-white text-slate-900 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none resize-none placeholder-slate-400"
