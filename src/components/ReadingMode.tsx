...
const ReadingMode: React.FC<ReadingModeProps> = ({ words, onExit }) => {
  ...
  const renderInteractiveText = (content: string) => {
    ...
    return (
      <div className="text-lg leading-loose text-slate-800 font-serif whitespace-pre-line">
    ...
    <div className="max-w-4xl mx-auto p-4 animate-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 sticky top-6 max-h-[calc(100vh-2rem)] overflow-y-auto">
